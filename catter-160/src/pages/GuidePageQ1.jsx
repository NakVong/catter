...
const slidesQ2 = [
    {
        ...
        description: "Look for cat food with real meat as the first ingredient. Avoid fillers like corn, soy, or vague 'meat by-products'.",
        image: "/images/guide/food1.jpg",
    },
    {
        title: "Step 2: Match Food to Life Stage 🎂",
        description: "Kittens, adults, and seniors have different needs. Choose food that's age-appropriate so they grow (or nap) strong.",
        image: "/images/guide/food2.jpg",
    },
    {
        title: "Step 3: Monitor Portions 🧮",
        description: "Follow the portion guide on the label based on your cat’s weight and activity level. Overfeeding = chunky loaf risk.",
        image: "/images/guide/food3.jpg",
    },
    {
        title: "Step 4: Provide Fresh Water 💧",
        description: "Always have clean water available. Many cats love drinking from fountains — it feels fancier and encourages hydration.",
        image: "/images/guide/food4.jpg",
    },
    {
        title: "Step 5: Avoid Toxic Foods 🚫",
        description: "No onions, garlic, chocolate, grapes, or dairy. Your cat might beg, but not everything human = safe for cats.",
...
const slidesQ3 = [
    {
        ...
        description: "You’ll need gloves, a scooper, trash bags, and optional mask (if you're sensitive to smells).",
        image: "/images/guide/litter1.jpg",
    },
    {
        title: "Step 2: Scoop Daily, Thank Yourself Later 🗑️",
        description: "Scoop out clumps and solid waste at least once a day. Your cat (and your nose) will thank you.",
        image: "/images/guide/litter2.jpeg",
    },
    {
        title: "Step 3: Top Off the Litter 🪣",
        description: "After scooping, add a bit of fresh litter to maintain the ideal depth (about 2–3 inches).",
        image: "/images/guide/litter3.jpg",
    },
    {
        title: "Step 4: Deep Clean Weekly 🧼",
        description: "Once a week, dump all the litter, wash the box with mild soap, dry it, and refill with fresh litter.",
        image: "/images/guide/litter4.jpg",
    },
    {
        title: "Step 5: Dispose Responsibly 🚮",
        description: "Seal waste in a bag and toss it in the trash. Do *not* flush clumps—your pipes will cry.",
...
const slidesQ5 = [
    
    {
        ...
        description: "Lay out towels, cat-safe shampoo, a cup for rinsing, and a non-slip mat. Have everything within reach—you won’t get a second chance.",
        image: "/images/guide/bath2.jpg",
    },
    {
        title: "Step 2: Use Lukewarm Water 🌡️",
        description: "Fill the tub or sink with a few inches of lukewarm water. No showers or strong sprays—just gentle pouring with a cup.",
        image: "/images/guide/bath3.jpg",
    },
    {
        title: "Step 3: Wash Gently, Avoid Face 🙀",
        description: "Massage the shampoo into their fur, avoiding eyes and ears. Rinse thoroughly—leftover soap = itchy regret.",
        image: "/images/guide/bath4.jpg",
    },
    {
        title: "Step 4: Dry and Reassure 🧺",
        description: "Wrap your cat in a towel burrito. Pat dry (don’t rub). Use a hairdryer on low if your cat tolerates it—and offer treats like you just survived a war together.",
...
const slidesQ4 = [
    {
        ...
        description: "Feather wand? Laser pointer? Crinkly mouse? Try different toys to see what sparks your cat’s inner hunter.",
        image: "/images/guide/play1.jpg",
    },
    {
        title: "Step 2: Let Them Chase, Not Just Watch 🕵️‍♂️",
        description: "Move the toy like real prey — slow, sneaky, and unpredictable. Make it fun, not frustrating.",
        image: "/images/guide/play2.jpg",
    },
    {
        title: "Step 3: Keep Sessions Short But Frequent ⏱️",
        description: "Play for 5–15 minutes at a time. Once or twice a day is perfect for keeping them happy and active.",
        image: "/images/guide/play3.jpg",
    },
    {
        title: "Step 4: Let Them ‘Win’ 💥",
        description: "End the game with a ‘catch’ — let them pounce on the toy and feel victorious. Instant serotonin boost.",
        image: "/images/guide/play4.jpg",
    },
    {
        title: "Step 5: Cool Down With Treats or Cuddles 🍗",
        description: "Reward their effort with a treat, some water, or chill cuddles. Playing builds trust, too!",
