...
const SubPage = () => {
      ...
      try {
        const res = await fetch("https://noggin.rea.gent/minimum-locust-8471", {
          ...
          headers: {
            ...
            Authorization: 'Bearer rg_v1_3ih6mj76av5277maq2r1b7pc3192hnfa7b65_ngk',
          },
          body: JSON.stringify({
    ...
    return(
        <div className="max-w-xl mx-auto p-6 bg-white min-h-screen rounded-xl shadow-md  border border-gray-200">
            <div>
                <h2 className="text-lg font-semibold text-gray-800 mb-1">Your question:</h2>
                <p className="text-gray-600 italic">{question}</p>
                
            </div>

            <div>
                <h2 className="text-lg font-semibold text-gray-800 mb-1">Catter Says:</h2>
            </div>
